...
-- @Last Modified time: 2016-04-15 20:59:32
...
local _M = {tag='ground', type='default', w=display.contentWidth, h=40, x=display.contentCenterX, y=display.contentHeight - 20}
